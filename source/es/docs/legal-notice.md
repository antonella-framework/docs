...
CIF: B75461269
Inscripción registral: Registro Mercantil de Cantabria Tomo 1, Folio 1, Sección 8, Hoja 38274, Inscripción 1.
...
El Usuario se compromete a respetar estos derechos y a abstenerse de cualquier actuación que pueda perjudicarlos, reservándose EL RESPONSABLE el ejercicio de todas las acciones legales que le correspondan para la defensa de sus legítimos derechos.
...
1.	Interferencias, interrupciones o fallos en el funcionamiento del sistema electrónico provocados por deficiencias, sobrecargas, errores en las líneas de telecomunicaciones o causas ajenas al control de EL RESPONSABLE.
2.	Intromisiones ilegítimas de terceros mediante el uso de software malicioso (como virus, malware, spyware o cualquier otro código dañino) que puedan alterar el normal funcionamiento del sitio web o causar daños a los sistemas informáticos de los usuarios.
3.	Uso indebido del sitio web por parte del usuario, contrario a este Aviso Legal, a la ley o a la buena fe, incluyendo un uso abusivo, fraudulento o desproporcionado de las funcionalidades disponibles.
4.	Errores de navegación o incompatibilidades técnicas provocadas por el uso de navegadores desactualizados o mal configurados, así como por cualquier fallo derivado de dispositivos del usuario.
...
El usuario responderá directamente por los daños y perjuicios que pueda ocasionar por el uso ilícito, negligente o doloso de estos servicios y se obliga a mantener indemne a EL RESPONSABLE frente a cualquier reclamación derivada del uso de estos canales.
