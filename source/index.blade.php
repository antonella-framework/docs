            ...
            <div class="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-3">
                        <span class="inline-flex items-center px-2 py-1 rounded text-xs font-bold uppercase tracking-wider bg-blue-500/20 text-blue-300 border border-blue-500/30">New</span>
                        <span class="text-sm text-gray-400">v1.9.3</span>
                    </div>
                    <h2 class="text-3xl font-bold text-white mb-3">Native ReactJS Integration</h2>
                    <p class="text-lg text-gray-300 mb-6 leading-relaxed">
                        Render React components from your controllers, shortcodes and admin pages. Powered by Vite with HMR, style isolation and zero-config setup.
                    </p>
                    <a href="/docs/react" class="inline-flex items-center bg-blue-500 hover:bg-blue-400 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-200 shadow-lg hover:shadow-blue-500/25">
